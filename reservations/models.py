...
class Reservation(models.Model):
    ...
    reservation_email = models.EmailField(blank=True)
    reservation_phone_number = models.IntegerField(blank=True)
    ...
    reservation_booked_by = models.ForeignKey(User, on_delete=models.SET_NULL)
