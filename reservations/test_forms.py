...
class TestReservationForm(TestCase):
    ...
    def test__name_is_required(self):
        ...
        reservation_form = ReservationForm({'reservation_name': '', 
                                            ...
                                            'reservation_time': '13:00', 
                                            'number_of_guests': '2'})
        self.assertFalse(reservation_form.is_valid(), msg="reservation_name field left blank, but form valid.")
    ...
    def test__date_is_required(self):
        ...
        reservation_form = ReservationForm({'reservation_name': 'Joe Bloggs', 
                                            ...
                                            'reservation_time': '13:00', 
                                            'number_of_guests': '2'})
        self.assertFalse(reservation_form.is_valid(), msg="reservation_date field left blank, but form valid.")
    ...
    def test__time_is_required(self):
        ...
        reservation_form = ReservationForm({'reservation_name': 'Joe Bloggs', 
                                            ...
                                            'reservation_time': '', 
                                            'number_of_guests': '2'})
        self.assertFalse(reservation_form.is_valid(), msg="reservation_time field left blank, but form valid.")
    ...
    def test__number_of_guests_is_required(self):
        ...
        reservation_form = ReservationForm({'reservation_name': 'Joe Bloggs', 
                                            ...
                                            'reservation_time': '13:00', 
                                            'number_of_guests': ''})
        self.assertFalse(reservation_form.is_valid(), msg="number_of_guests field left blank, but form valid.")